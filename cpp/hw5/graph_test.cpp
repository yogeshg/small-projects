...
void test(Graph& a) {
    try {
        ...
        std::cout << "# " << "are " << toDot(pV5) << " and "<< toDot(pV6) <<" adjacent? : " << a.adjacent(pV5, pV6) <<"\n";
        std::cout << "# " << "are " << toDot(pV5) << " and "<< toDot(pV1) <<" adjacent? : " << a.adjacent(pV5, pV1) <<"\n";
    } catch (const char* e) {
